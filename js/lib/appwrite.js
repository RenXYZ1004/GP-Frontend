/*!
 * Appwrite Web SDK v27.0.0 — vendored, not loaded from a CDN.
 *
 * This app ships as an offline-first PWA and has no bundler, matching how
 * jsQR and face-api are already carried here. The IIFE build is used because
 * the ESM one imports json-bigint, which nothing here could resolve.
 *
 * Exposes window.Appwrite. To update: copy dist/iife/sdk.js from the npm
 * package and keep this header.
 */
(function (exports) {
    'use strict';
